document.getElementById("header").innerHTML = '\
		...
		<div class="header" style="padding-top:10px; padding-bottom:10px; background:#e2e2e2">\
			<center>\
					<a href="mailto:sihangq@acm.org"><img src="./files/img/logos/email.png" height="30"/></a> &nbsp;\
					<a href="https://scholar.google.com/citations?hl=en&user=sDqDmq8AAAAJ&sortby=pubdate" target="_blank"><img src="./files/img/logos/google_scholar.png" height="30"/></a> &nbsp;\
